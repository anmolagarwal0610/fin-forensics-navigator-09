...
const Pricing = () => {
  return (
    <>
      <DocumentHead 
        title="Pricing — FinNavigator AI Enterprise Plans"
        description="Flexible enterprise pricing for FinNavigator AI financial forensics software. Custom SLAs, on-premises deployment, and government pricing available."
