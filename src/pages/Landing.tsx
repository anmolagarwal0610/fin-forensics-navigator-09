            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              duration: 0.8
                ...
                delay: 0.2
                  ...
                  <Badge variant="secondary" className="mb-6 text-sm font-medium bg-accent/10 text-accent border-accent/20">{t('landing.poweredByAI')}</Badge>
                </motion.div>
