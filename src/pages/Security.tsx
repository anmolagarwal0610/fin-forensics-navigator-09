...
const Security = () => {
  return (
    <>
      <DocumentHead 
        title="Security & Compliance — FinNavigator AI"
        description="Enterprise-grade security for financial forensics. SOC 2 Type II, end-to-end encryption, zero trust architecture, and compliance certifications."
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 max-w-4xl mx-auto">
              <Badge variant="outline" className="px-6 py-3 text-base">SOC 2 Type II</Badge>
              <Badge variant="outline" className="px-6 py-3 text-base">ISO 27001</Badge>
              <Badge variant="outline" className="px-6 py-3 text-base">GDPR Compliant</Badge>
              <Badge variant="outline" className="px-6 py-3 text-base">HIPAA Ready</Badge>
              <Badge variant="outline" className="px-6 py-3 text-base">PCI DSS</Badge>
            </div>
          </div>
