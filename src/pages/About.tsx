...
const About = () => {
  return (
    <>
      <DocumentHead 
        title="About FinNavigator AI — Financial Forensics Software Company"
        description="Learn about FinNavigator AI by Promarma Technologies. We build AI-powered tools for financial forensics, serving law enforcement and compliance teams."
        canonicalPath="/about"
      />
