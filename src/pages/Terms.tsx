      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Legal terms and conditions for using FinNavigator
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                By accessing and using FinNavigator, you accept and agree to be bound by the terms 
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                FinNavigator provides AI-powered financial document analysis services for 
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <p className="text-muted-foreground">
                FinNavigator is a tool to assist in financial analysis and should not be considered 
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="font-semibold mt-2">contact@promarma.tech</p>
            </CardContent>
          </Card>
        </div>

        <div className="text-center mt-16 text-sm text-muted-foreground">
          <p>FinNavigator — by Promarma Technologies</p>
